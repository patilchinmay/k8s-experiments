...
# installs ArgoCD on mgmt, registers all workers as ArgoCD external clusters,
# installs Kueue on all 4 clusters, creates worker kubeconfig Secrets on mgmt
# for MultiKueue, and applies the ApplicationSets that sync Kueue resources.
#
...
# ── 2. Install Kueue on all clusters ─────────────────────────────────────────
echo ""
