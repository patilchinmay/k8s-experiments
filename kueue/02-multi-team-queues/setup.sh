#!/usr/bin/env bash
# setup.sh
# Creates a Kind cluster and installs cert-manager + Kueue for the multi-team-queues experiment.
...
echo "   Run the experiment: see kueue/02-multi-team-queues/README.md"
