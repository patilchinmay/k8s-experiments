#!/usr/bin/env bash
# setup.sh
# Creates a Kind cluster and installs cert-manager + Kueue for the basic-job experiment.
...
# --wait above already blocks until all Kueue resources are ready,
# so no additional kubectl wait is needed here.

echo ""
echo "✅ Cluster and Kueue are ready."
echo "   Context: kind-kueue-cluster"
echo "   Run the experiment: see kueue/01-basic-job/README.md"
